...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        com.epsilonmusic.app.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        com.epsilonmusic.app.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        com.epsilonmusic.app.ui.component.CreateAiPlaylistDialog(
