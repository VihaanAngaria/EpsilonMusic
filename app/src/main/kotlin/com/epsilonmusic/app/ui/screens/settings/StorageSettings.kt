...
import com.epsilonmusic.app.constants.MaxImageCacheSizeKey
...
import com.epsilonmusic.app.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.epsilonmusic.app.playback.ExoDownloadService::class.java,
                    false
                )
