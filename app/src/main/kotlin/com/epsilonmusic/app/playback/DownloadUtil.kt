...
constructor(
    ...
    private val downloadQuality by enumPreference(context, com.epsilonmusic.app.constants.DownloadQualityKey, com.epsilonmusic.app.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = com.epsilonmusic.app.constants.AudioQuality.OPUS,
