...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "com.epsilonmusic.app.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "com.epsilonmusic.app.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "com.epsilonmusic.app.widget.playlists.UPDATE_WIDGET"
