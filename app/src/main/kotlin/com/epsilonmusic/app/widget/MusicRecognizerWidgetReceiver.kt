...
package com.epsilonmusic.app.widget
...
import com.epsilonmusic.app.recognition.MusicRecognitionService
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import com.epsilonmusic.app.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "com.epsilonmusic.app.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "com.epsilonmusic.app.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "com.epsilonmusic.app.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "com.epsilonmusic.app.widget.recognizer.RESET"
    }
}
