...
import echo.music.***REMOVED***.di.ApplicationScope
import echo.music.***REMOVED***.extensions.toEnum
import echo.music.***REMOVED***.extensions.toInetSocketAddress
import echo.music.***REMOVED***.utils.CrashHandler
import echo.music.***REMOVED***.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        echo.music.***REMOVED***.utils.cipher.CipherDeobfuscator.initialize(this)
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[echo.music.***REMOVED***.constants.PlaybackEngineKey]
        echo.music.***REMOVED***.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) echo.music.***REMOVED***.constants.PlaybackEngine.valueOf(engineName)
            else echo.music.***REMOVED***.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { echo.music.***REMOVED***.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        echo.music.***REMOVED***.utils.lastfm.LastFM.initialize(
