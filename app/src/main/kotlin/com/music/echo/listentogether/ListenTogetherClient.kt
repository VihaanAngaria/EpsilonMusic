...
package echo.music.***REMOVED***.listentogether
...
import echo.music.***REMOVED***.constants.ListenTogetherAutoApprovalKey
import echo.music.***REMOVED***.constants.ListenTogetherIsHostKey
import echo.music.***REMOVED***.constants.ListenTogetherRoomCodeKey
import echo.music.***REMOVED***.constants.ListenTogetherServerUrlKey
import echo.music.***REMOVED***.constants.ListenTogetherSessionTimestampKey
import echo.music.***REMOVED***.constants.ListenTogetherSessionTokenKey
import echo.music.***REMOVED***.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "echo.music.***REMOVED***.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "echo.music.***REMOVED***.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "echo.music.***REMOVED***.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "echo.music.***REMOVED***.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(echo.music.***REMOVED***.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[echo.music.***REMOVED***.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
