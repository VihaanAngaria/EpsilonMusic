...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "echo.music.***REMOVED***.MainActivityAlias")
        val static = ComponentName(context, "echo.music.***REMOVED***.MainActivityStatic")
        val legacy = ComponentName(context, "echo.music.***REMOVED***.MainActivityLegacy")
