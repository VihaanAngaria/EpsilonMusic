...
import echo.music.***REMOVED***.constants.DiscordActivityButton1CustomUrlKey
import echo.music.***REMOVED***.constants.DiscordActivityButton1EnabledKey
import echo.music.***REMOVED***.constants.DiscordActivityButton1LabelKey
import echo.music.***REMOVED***.constants.DiscordActivityButton1UrlSourceKey
import echo.music.***REMOVED***.constants.DiscordActivityButton2CustomUrlKey
import echo.music.***REMOVED***.constants.DiscordActivityButton2EnabledKey
import echo.music.***REMOVED***.constants.DiscordActivityButton2LabelKey
import echo.music.***REMOVED***.constants.DiscordActivityButton2UrlSourceKey
import echo.music.***REMOVED***.constants.DiscordActivityDetailsKey
import echo.music.***REMOVED***.constants.DiscordActivityNameKey
import echo.music.***REMOVED***.constants.DiscordActivityPlatformKey
import echo.music.***REMOVED***.constants.DiscordActivityStateKey
import echo.music.***REMOVED***.constants.DiscordActivityTypeKey
import echo.music.***REMOVED***.constants.DiscordLargeImageCustomUrlKey
import echo.music.***REMOVED***.constants.DiscordLargeImageTypeKey

import echo.music.***REMOVED***.constants.DiscordPresenceStatusKey
import echo.music.***REMOVED***.constants.DiscordShowWhenPausedKey
import echo.music.***REMOVED***.constants.DiscordSmallImageCustomUrlKey
