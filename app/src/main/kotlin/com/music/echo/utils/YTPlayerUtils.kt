...
import echo.music.***REMOVED***.utils.PlaybackLogLevel
...
import echo.music.***REMOVED***.utils.cipher.CipherDeobfuscator
import echo.music.***REMOVED***.utils.YTPlayerUtils.MAIN_CLIENT
import echo.music.***REMOVED***.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import echo.music.***REMOVED***.utils.YTPlayerUtils.validateStatus
import echo.music.***REMOVED***.utils.potoken.PoTokenGenerator
import echo.music.***REMOVED***.utils.potoken.PoTokenResult
import echo.music.***REMOVED***.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: echo.music.***REMOVED***.constants.PlaybackEngine = echo.music.***REMOVED***.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == echo.music.***REMOVED***.constants.PlaybackEngine.POTOKEN || engine == echo.music.***REMOVED***.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == echo.music.***REMOVED***.constants.PlaybackEngine.BRAVEPIPE || engine == echo.music.***REMOVED***.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
