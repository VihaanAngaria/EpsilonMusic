...
import echo.music.***REMOVED***.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, echo.music.***REMOVED***.constants.DownloadQualityKey, echo.music.***REMOVED***.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = echo.music.***REMOVED***.constants.AudioQuality.OPUS,
