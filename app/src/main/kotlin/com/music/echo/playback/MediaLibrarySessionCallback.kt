...
import echo.music.***REMOVED***.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(echo.music.***REMOVED***.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun echo.music.***REMOVED***.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
