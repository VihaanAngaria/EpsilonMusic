...
package echo.music.***REMOVED***.widget
...
import echo.music.***REMOVED***.recognition.MusicRecognitionService
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import echo.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "echo.music.***REMOVED***.action.RECOGNITION"
