...
import echo.music.***REMOVED***.ui.screens.artist.ArtistAlbumsScreen
import echo.music.***REMOVED***.ui.screens.artist.ArtistItemsScreen
import echo.music.***REMOVED***.ui.screens.artist.ArtistScreen
import echo.music.***REMOVED***.ui.screens.artist.ArtistSongsScreen
import echo.music.***REMOVED***.ui.screens.equalizer.EqScreen
import echo.music.***REMOVED***.ui.screens.library.LibraryScreen
import echo.music.***REMOVED***.ui.screens.library.LocalSongScreen
import echo.music.***REMOVED***.ui.screens.playlist.AutoPlaylistScreen
import echo.music.***REMOVED***.ui.screens.playlist.CachePlaylistScreen
import echo.music.***REMOVED***.ui.screens.playlist.LocalPlaylistScreen
import echo.music.***REMOVED***.ui.screens.playlist.OnlinePlaylistScreen
import echo.music.***REMOVED***.ui.screens.playlist.TopPlaylistScreen
import echo.music.***REMOVED***.ui.screens.search.OnlineSearchResult
import echo.music.***REMOVED***.ui.screens.search.SearchScreen
import echo.music.***REMOVED***.ui.screens.settings.AboutScreen
import echo.music.***REMOVED***.ui.screens.settings.AppearanceSettings
import echo.music.***REMOVED***.ui.screens.settings.GlassEffectSettings
import echo.music.***REMOVED***.ui.screens.settings.BackupAndRestore
import echo.music.***REMOVED***.ui.screens.settings.ContentSettings
import echo.music.***REMOVED***.ui.screens.settings.UptimeScreen
import echo.music.***REMOVED***.ui.screens.settings.DarkMode
import echo.music.***REMOVED***.ui.screens.settings.PlayerSettings
import echo.music.***REMOVED***.ui.screens.settings.PrivacySettings
import echo.music.***REMOVED***.ui.screens.settings.RomanizationSettings
import echo.music.***REMOVED***.ui.screens.settings.SettingsScreen
import echo.music.***REMOVED***.ui.screens.settings.AccountSettingsScreen
import echo.music.***REMOVED***.ui.screens.settings.StorageSettings
import echo.music.***REMOVED***.ui.screens.settings.ThemeScreen
import echo.music.***REMOVED***.ui.screens.settings.AiSettings

import echo.music.***REMOVED***.ui.screens.settings.integrations.ListenTogetherSettings
import echo.music.***REMOVED***.ui.screens.recognition.RecognitionScreen
import echo.music.***REMOVED***.ui.screens.recognition.RecognitionHistoryScreen
import echo.music.***REMOVED***.ui.screens.settings.UpdateSettings
import echo.music.***REMOVED***.echomusic.updater.UpdateScreen
import echo.music.***REMOVED***.utils.rememberEnumPreference
import echo.music.***REMOVED***.utils.rememberPreference
import echo.music.***REMOVED***.echomusic.changelog.ChangelogScreen
import echo.music.***REMOVED***.echomusic.commitscreen.CommitScreen
import echo.music.***REMOVED***.ui.screens.equalizer.axion.AxionEqScreen
import echo.music.***REMOVED***.ui.screens.ambient.AmbientModeScreen
...
fun NavGraphBuilder.navigationBuilder(
    ...
    composable("settings/discord") {
        echo.music.***REMOVED***.ui.screens.settings.DiscordSettings(navController, scrollBehavior)
    }
