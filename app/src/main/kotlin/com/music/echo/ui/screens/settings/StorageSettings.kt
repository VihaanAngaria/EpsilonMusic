...
import echo.music.***REMOVED***.constants.MaxImageCacheSizeKey
import echo.music.***REMOVED***.constants.MaxSongCacheSizeKey
import echo.music.***REMOVED***.extensions.tryOrNull
...
import echo.music.***REMOVED***.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    echo.music.***REMOVED***.playback.ExoDownloadService::class.java,
                    false
                )
