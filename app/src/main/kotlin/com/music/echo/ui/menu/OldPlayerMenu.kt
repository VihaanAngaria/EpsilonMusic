                ...
                items = buildList {
                    add(
                        Material3MenuItemData(
                            customComposable = {
                                echo.music.***REMOVED***.ui.component.CastButton(asMenuItem = true)
                            }
                        )
                    )
                    ...
                    add(
                        Material3MenuItemData(
                            ...
                            onClick = {
                                ...
                                androidx.media3.exoplayer.offline.DownloadService.sendRemoveDownload(context, echo.music.***REMOVED***.playback.ExoDownloadService::class.java, mediaMetadata.id, false)
