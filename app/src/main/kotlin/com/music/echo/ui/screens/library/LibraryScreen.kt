...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        echo.music.***REMOVED***.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        echo.music.***REMOVED***.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        echo.music.***REMOVED***.ui.component.CreateAiPlaylistDialog(
