...
package epsilon.music.***REMOVED***.epsilonmusic.updater
...
import epsilon.music.***REMOVED***.epsilonmusic.updater.downloadmanager.UpdateDownloadWorker
import epsilon.music.***REMOVED***.epsilonmusic.updater.downloadmanager.DownloadNotificationManager
...
import epsilon.music.***REMOVED***.ui.component.ChangelogItem
import epsilon.music.***REMOVED***.ui.component.leadingItemShape
import epsilon.music.***REMOVED***.ui.component.middleItemShape
import epsilon.music.***REMOVED***.ui.component.endItemShape
import epsilon.music.***REMOVED***.ui.component.detachedItemShape
import epsilon.music.***REMOVED***.ui.component.parseMarkdown
import epsilon.music.***REMOVED***.ui.component.endItemShape
import epsilon.music.***REMOVED***.ui.component.detachedItemShape
import epsilon.music.***REMOVED***.ui.component.AnimatedActionButton
import epsilon.music.***REMOVED***.ui.component.ExpressiveIconButton
import epsilon.music.***REMOVED***.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/VihaanAngaria/EpsilonMusic/releases/download/${currentStatus.version}/epsilonmusic.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/VihaanAngaria/EpsilonMusic/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/VihaanAngaria/EpsilonMusic/releases/download/$tagWithPrefix/changelog.json")
