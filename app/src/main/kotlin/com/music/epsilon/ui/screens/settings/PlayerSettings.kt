...
import epsilon.music.***REMOVED***.constants.AutomixDebugOverlayKey
...
import epsilon.music.***REMOVED***.constants.EnableGoogleCastKey
...
import epsilon.music.***REMOVED***.constants.SeekExtraSeconds
...
import epsilon.music.***REMOVED***.constants.EnableExportAsMp3Key
...
highlightKey: String? = null) {
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = epsilon.music.***REMOVED***.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (playbackEngine, onPlaybackEngineChange) = rememberEnumPreference(
        epsilon.music.***REMOVED***.constants.PlaybackEngineKey,
        defaultValue = epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO
    )

    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        epsilon.music.***REMOVED***.constants.DownloadQualityKey,
        defaultValue = epsilon.music.***REMOVED***.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = listOf(epsilon.music.***REMOVED***.constants.DownloadQuality.YOUTUBE),
            valueText = {
                when (it) {
                    epsilon.music.***REMOVED***.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    else -> ""
                }
            }
        )
    ...
    if (showPlaybackEngineDialog) {
        EnumDialog(
            ...
            onSelect = {
                ...
                epsilon.music.***REMOVED***.utils.YTPlayerUtils.playbackEngine = it
                showPlaybackEngineDialog = false
            },
            title = "Playback Engine",
            current = playbackEngine,
            values = listOf(
                epsilon.music.***REMOVED***.constants.PlaybackEngine.POTOKEN,
                epsilon.music.***REMOVED***.constants.PlaybackEngine.BRAVEPIPE,
                epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO,
            ),
            valueText = {
                when (it) {
                    epsilon.music.***REMOVED***.constants.PlaybackEngine.POTOKEN -> "PoToken (Recommended)"
                    epsilon.music.***REMOVED***.constants.PlaybackEngine.BRAVEPIPE -> "BravePipe (NewPipe)"
                    epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO -> "Auto (Try Both)"
                }
            },
            valueDescription = {
                when (it) {
                    epsilon.music.***REMOVED***.constants.PlaybackEngine.POTOKEN -> "Uses WebView PoToken + CipherDeobfuscator. Most reliable and future-proof."
                    epsilon.music.***REMOVED***.constants.PlaybackEngine.BRAVEPIPE -> "Uses NewPipe extractor for stream resolution. Lightweight but may break with YouTube updates."
                    epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO -> "Tries PoToken first, falls back to BravePipe if it fails."
                }
            }
        )
    }
