...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        epsilon.music.***REMOVED***.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        epsilon.music.***REMOVED***.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        epsilon.music.***REMOVED***.ui.component.CreateAiPlaylistDialog(
