...
import epsilon.music.***REMOVED***.constants.MaxImageCacheSizeKey
import epsilon.music.***REMOVED***.constants.MaxSongCacheSizeKey
import epsilon.music.***REMOVED***.extensions.tryOrNull
...
import epsilon.music.***REMOVED***.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    epsilon.music.***REMOVED***.playback.ExoDownloadService::class.java,
                    false
                )
