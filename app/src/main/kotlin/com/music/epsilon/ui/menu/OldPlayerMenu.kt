                ...
                items = buildList {
                    add(
                        Material3MenuItemData(
                            customComposable = {
                                epsilon.music.***REMOVED***.ui.component.CastButton(asMenuItem = true)
                            }
                        )
                    )
                    ...
                    add(
                        Material3MenuItemData(
                            ...
                            onClick = {
                                ...
                                androidx.media3.exoplayer.offline.DownloadService.sendRemoveDownload(context, epsilon.music.***REMOVED***.playback.ExoDownloadService::class.java, mediaMetadata.id, false)
