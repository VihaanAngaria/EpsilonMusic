...
import epsilon.music.***REMOVED***.di.ApplicationScope
import epsilon.music.***REMOVED***.extensions.toEnum
import epsilon.music.***REMOVED***.extensions.toInetSocketAddress
import epsilon.music.***REMOVED***.utils.CrashHandler
import epsilon.music.***REMOVED***.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        epsilon.music.***REMOVED***.utils.cipher.CipherDeobfuscator.initialize(this)
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[epsilon.music.***REMOVED***.constants.PlaybackEngineKey]
        epsilon.music.***REMOVED***.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) epsilon.music.***REMOVED***.constants.PlaybackEngine.valueOf(engineName)
            else epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        epsilon.music.***REMOVED***.utils.lastfm.LastFM.initialize(
