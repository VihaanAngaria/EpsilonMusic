...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "epsilon.music.***REMOVED***.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "epsilon.music.***REMOVED***.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "epsilon.music.***REMOVED***.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "epsilon.music.***REMOVED***.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
