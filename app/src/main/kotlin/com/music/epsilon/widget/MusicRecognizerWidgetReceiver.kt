...
package epsilon.music.***REMOVED***.widget
...
import epsilon.music.***REMOVED***.recognition.MusicRecognitionService
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import epsilon.music.***REMOVED***.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "epsilon.music.***REMOVED***.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "epsilon.music.***REMOVED***.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "epsilon.music.***REMOVED***.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "epsilon.music.***REMOVED***.widget.recognizer.RESET"
    }
}
