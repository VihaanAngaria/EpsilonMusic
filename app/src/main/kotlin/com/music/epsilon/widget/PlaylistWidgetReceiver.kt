...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "epsilon.music.***REMOVED***.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "epsilon.music.***REMOVED***.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "epsilon.music.***REMOVED***.widget.playlists.UPDATE_WIDGET"
