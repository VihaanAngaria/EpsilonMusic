...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "epsilon.music.***REMOVED***.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "epsilon.music.***REMOVED***.widget.LIKE"
        const val ACTION_NEXT = "epsilon.music.***REMOVED***.widget.NEXT"
        const val ACTION_PREVIOUS = "epsilon.music.***REMOVED***.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "epsilon.music.***REMOVED***.widget.UPDATE_WIDGET"
    }
}
