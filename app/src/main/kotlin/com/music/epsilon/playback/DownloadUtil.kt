...
import epsilon.music.***REMOVED***.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, epsilon.music.***REMOVED***.constants.DownloadQualityKey, epsilon.music.***REMOVED***.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = epsilon.music.***REMOVED***.constants.AudioQuality.OPUS,
