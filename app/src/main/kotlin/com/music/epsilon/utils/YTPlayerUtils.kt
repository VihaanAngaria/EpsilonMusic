...
import epsilon.music.***REMOVED***.utils.PlaybackLogLevel
...
import epsilon.music.***REMOVED***.utils.cipher.CipherDeobfuscator
import epsilon.music.***REMOVED***.utils.YTPlayerUtils.MAIN_CLIENT
import epsilon.music.***REMOVED***.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import epsilon.music.***REMOVED***.utils.YTPlayerUtils.validateStatus
import epsilon.music.***REMOVED***.utils.potoken.PoTokenGenerator
import epsilon.music.***REMOVED***.utils.potoken.PoTokenResult
import epsilon.music.***REMOVED***.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: epsilon.music.***REMOVED***.constants.PlaybackEngine = epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == epsilon.music.***REMOVED***.constants.PlaybackEngine.POTOKEN || engine == epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == epsilon.music.***REMOVED***.constants.PlaybackEngine.BRAVEPIPE || engine == epsilon.music.***REMOVED***.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
