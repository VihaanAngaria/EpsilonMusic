...
package epsilon.music.***REMOVED***.utils

import android.content.Context
import epsilon.music.***REMOVED***.BuildConfig
import epsilon.music.***REMOVED***.R
import epsilon.music.***REMOVED***.constants.DiscordActivityButton1CustomUrlKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton1EnabledKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton1LabelKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton1UrlSourceKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton2CustomUrlKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton2EnabledKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton2LabelKey
import epsilon.music.***REMOVED***.constants.DiscordActivityButton2UrlSourceKey
import epsilon.music.***REMOVED***.constants.DiscordActivityDetailsKey
import epsilon.music.***REMOVED***.constants.DiscordActivityNameKey
import epsilon.music.***REMOVED***.constants.DiscordActivityPlatformKey
import epsilon.music.***REMOVED***.constants.DiscordActivityStateKey
import epsilon.music.***REMOVED***.constants.DiscordActivityTypeKey
import epsilon.music.***REMOVED***.constants.DiscordLargeImageCustomUrlKey
import epsilon.music.***REMOVED***.constants.DiscordLargeImageTypeKey

import epsilon.music.***REMOVED***.constants.DiscordPresenceStatusKey
import epsilon.music.***REMOVED***.constants.DiscordShowWhenPausedKey
import epsilon.music.***REMOVED***.constants.DiscordSmallImageCustomUrlKey
import epsilon.music.***REMOVED***.constants.DiscordSmallImageTypeKey
import epsilon.music.***REMOVED***.constants.DiscordSmallImageTypeKey
import epsilon.music.***REMOVED***.db.entities.Song
import epsilon.music.***REMOVED***.discord.DiscordActivityPlatform
import epsilon.music.***REMOVED***.discord.DiscordActivityType
import epsilon.music.***REMOVED***.discord.DiscordOnlineStatus
import epsilon.music.***REMOVED***.discord.DiscordPresenceActivity
import epsilon.music.***REMOVED***.discord.DiscordPresenceAssets
import epsilon.music.***REMOVED***.discord.DiscordPresenceButton
import epsilon.music.***REMOVED***.discord.DiscordPresenceTimestamps
import epsilon.music.***REMOVED***.discord.DiscordSocialPresenceClient
import epsilon.music.***REMOVED***.discord.DiscordStatusDisplayType
...
class DiscordRPC(
    ...
    private suspend fun resolveButtons(song: Song): List<DiscordPresenceButton> {
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Epsilon Music"
        ...
        val button2CustomUrl =
            context.dataStore[DiscordActivityButton2CustomUrlKey]
                ?: "https://github.com/VihaanAngaria/EpsilonMusic"
