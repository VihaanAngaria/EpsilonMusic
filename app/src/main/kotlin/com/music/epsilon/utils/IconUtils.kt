...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "epsilon.music.***REMOVED***.MainActivityAlias")
        val static = ComponentName(context, "epsilon.music.***REMOVED***.MainActivityStatic")
        val legacy = ComponentName(context, "epsilon.music.***REMOVED***.MainActivityLegacy")
