...
data class SongItem(
    ...
    override val shareLink: String
        get() = "https://share.epsilonmusic.app/watch?v=$id"
}
...
data class AlbumItem(
    ...
    override val shareLink: String
        get() = "https://share.epsilonmusic.app/playlist?list=$playlistId"
}
...
data class PlaylistItem(
    ...
    override val explicit: Boolean
        get() = false
    override val shareLink: String
        get() = "https://share.epsilonmusic.app/playlist?list=$id"
}
...
data class ArtistItem(
    ...
    override val explicit: Boolean
        get() = false
    override val shareLink: String
        get() = "https://share.epsilonmusic.app/channel/$id"
}
